...
HD_PWD='C:/Users/CSE.CAL/Desktop/MarawanMahmoud/Lec_Project_Code_rules/project_ms3_new/project_ms3_new.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log FullProcessorPipelined.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source FullProcessorPipelined.tcl
