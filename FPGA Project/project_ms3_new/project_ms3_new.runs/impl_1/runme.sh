...
HD_PWD='C:/Users/CSE.CAL/Desktop/MarawanMahmoud/Lec_Project_Code_rules/project_ms3_new/project_ms3_new.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log FullProcessorPipelined.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source FullProcessorPipelined.tcl -notrace
