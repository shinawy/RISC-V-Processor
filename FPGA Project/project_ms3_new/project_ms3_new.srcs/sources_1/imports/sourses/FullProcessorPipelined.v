...
module FullProcessorPipelined( input ssdclk, input uart_in,  
...
Accumulativeflip #(64)
 IF_ID( {PC,instr_mem_out_updated}, ~slowerclk, rst,1'b1,{IF_ID_PC,IF_ID_instrmemout} );
...
wire loadbyte,loadhalf,signedmem;
...
ripple0 mod10(first_input_for_second_adder, ID_EX_immgen_out,0,second_adder_output);
  ...
  wire [8:0] ID_EX_signals={ID_EX_Branch, ID_EX_MemRead, ID_EX_MemtoReg,  ID_EX_MemWrite,
      ...
      muxarray #(9) before_EX_MEM_signals(ID_EX_signals,9'd0,or_out,ID_EX_updated_signals);
...
reg [12:0] num;
 always @(*)begin
  case(ssdsel)
  4'b0000: num= PC;
  4'b0001: num=instr_mem_out_updated;
  4'b0010: num= second_adder_output;
  4'b0011: num= PCmux;
  
  4'b0100: num=regfileout1;
    4'b0101: num= regfileout2;
    4'b0110: num= {instr_mem_out_updated[19:15],instr_mem_out_updated[24:20], instr_mem_out_updated[11:7]};
